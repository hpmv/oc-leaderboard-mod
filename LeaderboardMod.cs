...
namespace OCLeaderboardMod
{
    [BepInPlugin("dev.hpmv.overcooked.experimental.interceptors.v1", "Hpmv Overcooked Experimental Interceptors V1", "1.0.0.0")]
    [BepInProcess("Overcooked2.exe")]
    public class LeaderboardMod : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            UnityEngine.Debug.Log("Overcooked 2 Leaderboard Mod V1 Loaded! Brought to you by hpmv & greeny.");
        }
        ...
        void Update()
        {
            ...
            {
                foreach (var instance in FindObjectsOfType<WorldMapKitchenLevelIconUI>())
                {
        ...
        {
            HarmonyWrapper.PatchAll(typeof(LeaderboardMod));
        }
        ...
        private static GameObject RearrangeLevelPreviewLayout(GameObject layoutRoot)
        {
            try
            {
                ...
                DestroyImmediate(rootPanel.GetComponent<VerticalLayoutGroup>());
                {
